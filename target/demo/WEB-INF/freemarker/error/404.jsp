...
<link rel="stylesheet" href="${pageContext.request.contextPath}/error/files/qbase_datauri.css" type="text/css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath}/error/files/qbase.css" type="text/css"/>
</head>
<body>
